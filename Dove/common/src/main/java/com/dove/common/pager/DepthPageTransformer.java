 ...
 * <em>
 * Note: During the depth animation, the default animation (a screen slide) still takes place,
 * so you must counteract the screen slide with a negative X translation. For example:</em>
 * <pre>
 *     <code>
