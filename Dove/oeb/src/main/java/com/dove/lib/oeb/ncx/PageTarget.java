...
public class PageTarget extends SimpleTextElement {
    ...
    public static final ClassLoaderCreator<PageTarget> CREATOR = new ParcelableCreator<>(PageTarget.class);
    ...
    protected void onSerializeAttributes(XmlSerializer serializer)
        ...
        serializeValue(serializer, "", OEBContract.Attributes.TYPE, mType.toString());
    }
}
