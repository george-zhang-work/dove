...
public class Spine extends SimpleElement {
    ...
    public static final ClassLoaderCreator<Spine> CREATOR = new ParcelableCreator<>(Spine.class);
    ...
    protected void onSerializeAttributes(XmlSerializer serializer)
        ...
        serializeValue(serializer, "", OEBContract.Attributes.TOC, mToc);
        serializeCollection(serializer, mItemRefs);
    }
}
