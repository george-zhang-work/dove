...
/**
 * General pupose {@link ContentProvider} base class that use SQLiteDatabase for
 * storage.
 */
public abstract class SQLiteContentProvider extends ContentProvider implements
    ...
    /**
     * The equivalent of the {@link #udpate} method, but invoked within a
     * transaction.
     */
    ...
    /**
     * @return A {@link SQLiteOpenHelper} is associated with this datase.
     */
